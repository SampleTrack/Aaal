...
async def start_command(client: Client, message: Message):
    """
    Handles the /start command for both private chats and groups.
    """
...
async def help_command(client: Client, message: Message):
    """
    Provides a list of available commands to the users.
    """
    help_text = (
        "**📚 Bot Command Guide**\n\n"
        "**Free Moderation:**\n"
...
# We can also add a quick callback query handler to make the 'Help' button on the start menu work!
